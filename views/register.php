    ...
    <div class="container">
        ...
        <form action="" id="register-form">
            ...
            <div class="register-gender">
                <input type="radio" value="" id="register_gender_m" class="register_gender_checkbox" name="register_gender">
                <label for="register_gender_m" id="register_gender_label_m">
                    <i class="fa fa-check"></i>
                </label>
                <span>남성</span>
                <input type="radio" value="" id="register_gender_w" class="register_gender_checkbox" name="register_gender">
